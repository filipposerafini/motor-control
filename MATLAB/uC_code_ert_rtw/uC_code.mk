###########################################################################
## Makefile generated for Simulink model 'uC_code'. 
## 
## Makefile     : uC_code.mk
## Generated on : Sat Jan 26 17:43:04 2019
## MATLAB Coder version: 4.1 (R2018b)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/uC_code.elf
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = E:/Università/MAGIST~1/COMPLI~1/MOTOR-~1/MATLAB
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
COMPILER_COMMAND_FILE     = uC_code_comp.rsp
CMD_FILE                  = uC_code.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/uC_code.elf
...
DEFINES_STANDARD = -DMODEL=uC_code -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = MW_AnalogInput.o MW_PWM.o MW_digitalIO.o uC_code.o mw_mbed_interface.o BufferedSerial.o SysTickScheduler.o m3m4m4f_multitasking.o
...
%.o : $(START_DIR)/uC_code_ert_rtw/%.c
	$(CC) $(CFLAGS) -o $@ $<


%.o : $(START_DIR)/uC_code_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o $@ $<
...
%.o : $(START_DIR)/uC_code_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o $@ $<


%.o : $(START_DIR)/uC_code_ert_rtw/%.cc
	$(CPP) $(CPPFLAGS) -o $@ $<
...
%.o : $(START_DIR)/uC_code_ert_rtw/%.cxx
	$(CPP) $(CPPFLAGS) -o $@ $<
