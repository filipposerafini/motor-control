...
static void xzlarf_tQsI3TnT_o(int32_T m, int32_T n, int32_T iv0, real_T tau,
  real_T C[16], int32_T ic0, real_T work[4]);
static void xgehrd_vbf45fhC_k(real_T a[16], real_T tau[3]);
static real_T xnrm2_hQNiN0t8_e(int32_T n, const real_T x[3]);
static real_T xzlarfg_J3AXVwxO_h(int32_T n, real_T *alpha1, real_T x[3]);
static void xdlanv2_FIBA3SmX_o(real_T *a, real_T *b, real_T *c, real_T *d,
  real_T *rt1r, real_T *rt1i, real_T *rt2r, real_T *rt2i, real_T *cs, real_T *sn);
static void xrot_JzPltzlP_i(int32_T n, real_T x[16], int32_T ix0, int32_T iy0,
  real_T c, real_T s);
static void xrot_DROkKeLU_e(int32_T n, real_T x[16], int32_T ix0, int32_T iy0,
  real_T c, real_T s);
static void xrot_6iHri7if_j(real_T x[16], int32_T ix0, int32_T iy0, real_T c,
  real_T s);
static int32_T eml_dlahqr_HClTWgbm_j(real_T h[16], real_T z[16]);
static void schur_hD1lAh31_b(const real_T A[16], real_T V[16], real_T T[16]);
...
static void xgehrd_vbf45fhC_k(real_T a[16], real_T tau[3])
{
  ...
  rtDW.alpha1 = a[1];
  rtDW.b = 0.0;
  rtDW.xnorm = xnrm2_ooZ215qV(2, a, 3);
  if (rtDW.xnorm != 0.0) {
    ...
    if (fabs(rtDW.xnorm) < 1.0020841800044864E-292) {
      ...
      rtDW.xnorm = rt_hypotd_snf_a(rtDW.alpha1, xnrm2_ooZ215qV(2, a, 3));
      if (rtDW.alpha1 >= 0.0) {
        rtDW.xnorm = -rtDW.xnorm;
      }
  ...
  xzlarf_tQsI3TnT_o(3, 3, 2, rtDW.b, a, 6, rtDW.work_c);
  a[1] = rtDW.alpha1;
  rtDW.alpha1 = a[6];
  rtDW.b = 0.0;
  rtDW.xnorm = xnrm2_ooZ215qV(1, a, 8);
  if (rtDW.xnorm != 0.0) {
    ...
    if (fabs(rtDW.xnorm) < 1.0020841800044864E-292) {
      ...
      rtDW.xnorm = rt_hypotd_snf_a(rtDW.alpha1, xnrm2_ooZ215qV(1, a, 8));
      if (rtDW.alpha1 >= 0.0) {
        rtDW.xnorm = -rtDW.xnorm;
      }
  ...
  xzlarf_tQsI3TnT_o(2, 2, 7, rtDW.b, a, 11, rtDW.work_c);
  a[6] = rtDW.alpha1;
  rtDW.alpha1 = a[11];
  rtDW.b = 0.0;
  rtDW.xnorm_tmp = xnrm2_ooZ215qV(0, a, 12);
  ...
  xzlarf_tQsI3TnT_o(1, 1, 12, rtDW.b, a, 16, rtDW.work_c);
  a[11] = rtDW.alpha1;
}
...
static real_T xzlarfg_J3AXVwxO_h(int32_T n, real_T *alpha1, real_T x[3])
{
  ...
  tau = 0.0;
  if (n > 0) {
    rtDW.xnorm_b = xnrm2_hQNiN0t8_e(n - 1, x);
    if (rtDW.xnorm_b != 0.0) {
      ...
      if (fabs(rtDW.xnorm_b) < 1.0020841800044864E-292) {
        ...
        rtDW.xnorm_b = rt_hypotd_snf_a(*alpha1, xnrm2_hQNiN0t8_e(n - 1, x));
        if ((*alpha1) >= 0.0) {
          rtDW.xnorm_b = -rtDW.xnorm_b;
        }
      ...
      *sn = 0.0;
      ...
      if (rtDW.z >= 8.8817841970012523E-16) {
        ...
        *c = ((-rtDW.p) * (*sn)) + (rtDW.bcmax * (*cs));
        rtDW.bcmax = (((rtDW.p * (*cs)) + (rtDW.bcmax * (*sn))) + (((-rtDW.tau_c)
          * (*sn)) + (rtDW.bcmis * (*cs)))) * 0.5;
        *a = rtDW.bcmax;
        *d = rtDW.bcmax;
        if ((*c) != 0.0) {
          if ((*b) != 0.0) {
  ...
  while ((!exitg1) && ((i + 1) >= 1)) {
    ...
    while ((!exitg2) && (its < 301)) {
      ...
      while ((!exitg3) && ((k + 1) > L)) {
        ...
        if (rtDW.ba <= 4.0083367200179456E-292) {
          ...
          if (rtDW.ba <= (2.2204460492503131E-16 * rtDW.tst)) {
            ...
            rtDW.htmp2 = fabs(rtDW.s - h[(k * 4) + k]);
      ...
      if ((k + 1) >= i) {
        ...
        switch (its) {
         case 10:
          rtDW.s = fabs(h[(((k + 1) * 4) + k) + 2]) + fabs(h[((k * 4) + k) + 1]);
          rtDW.ba = h[(k * 4) + k] + (0.75 * rtDW.s);
         ...
         case 20:
          rtDW.s = fabs(h[(((i - 2) * 4) + i) - 1]) + fabs(h[((i - 1) * 4) + i]);
          rtDW.ba = h[(i * 4) + i] + (0.75 * rtDW.s);
          rtDW.aa = -0.4375 * rtDW.s;
          rtDW.htmp2 = rtDW.s;
          rtDW.tst = rtDW.ba;
          break;
        ...
        while ((!exitg3) && (m >= (k + 1))) {
          ...
          rtDW.h21s = h[((m - 1) * 4) + m] / rtDW.s;
          s_tmp = (m * 4) + m;
          rtDW.v[0] = (((rtDW.sum1 / rtDW.s) * (rtDW.aa - rtDW.ba)) + (h[s_tmp -
            1] * rtDW.h21s)) - ((rtDW.htmp2 / rtDW.s) * rtDW.tst);
          ...
          if ((k + 1) == m) {
            ...
            j = ((m - 2) * 4) + m;
            if ((fabs(h[j - 1]) * (fabs(rtDW.v[1]) + fabs(rtDW.v[2]))) <=
                (((fabs(h[j - 2]) + fabs(rtDW.aa)) + fabs(h[(m * 4) + m])) *
        ...
        for (s_tmp = m; s_tmp <= i; s_tmp++) {
          ...
          rtDW.b_v[1] = rtDW.v[1];
          rtDW.b_v[2] = rtDW.v[2];
          rtDW.s = xzlarfg_J3AXVwxO_h(nr, &rtDW.ba, rtDW.b_v);
          rtDW.v[1] = rtDW.b_v[1];
          rtDW.v[2] = rtDW.b_v[2];
          rtDW.v[0] = rtDW.ba;
          if (s_tmp > m) {
            h[(s_tmp + ((s_tmp - 2) * 4)) - 1] = rtDW.ba;
            h[s_tmp + ((s_tmp - 2) * 4)] = 0.0;
            if (s_tmp < i) {
              h[(s_tmp + ((s_tmp - 2) * 4)) + 1] = 0.0;
            }
          } else {
            if (m > (k + 1)) {
              h[(s_tmp + ((s_tmp - 2) * 4)) - 1] *= 1.0 - rtDW.s;
            }
          }
          ...
          switch (nr) {
           case 3:
            ...
            for (b_j = 0; b_j < j; b_j++) {
              rtDW.aa = h[((s_tmp - 1) * 4) + b_j];
              nr = (s_tmp * 4) + b_j;
              hoffset_tmp = ((s_tmp + 1) * 4) + b_j;
              rtDW.sum1 = (rtDW.aa + (h[nr] * rtDW.ba)) + (h[hoffset_tmp] *
                rtDW.bb);
              h[b_j + ((s_tmp - 1) * 4)] = rtDW.aa - (rtDW.sum1 * rtDW.s);
              h[b_j + (s_tmp * 4)] = h[nr] - (rtDW.sum1 * rtDW.tst);
              h[b_j + ((s_tmp + 1) * 4)] = h[hoffset_tmp] - (rtDW.sum1 *
                rtDW.htmp2);
            }
            ...
            for (b_j = 0; b_j < 4; b_j++) {
              j = (s_tmp - 1) * 4;
              rtDW.aa = z[j + b_j];
              sum1_tmp_tmp = s_tmp * 4;
              nr = sum1_tmp_tmp + b_j;
              sum1_tmp_tmp_0 = (s_tmp + 1) * 4;
              hoffset_tmp = sum1_tmp_tmp_0 + b_j;
              rtDW.sum1 = (rtDW.aa + (z[nr] * rtDW.ba)) + (z[hoffset_tmp] *
                rtDW.bb);
           ...
           case 2:
            ...
            for (j = 0; j <= i; j++) {
              nr = ((s_tmp - 1) * 4) + j;
              hoffset_tmp = (s_tmp * 4) + j;
              rtDW.sum1 = h[nr] + (h[hoffset_tmp] * rtDW.ba);
              h[j + ((s_tmp - 1) * 4)] = h[nr] - (rtDW.sum1 * rtDW.s);
              h[j + (s_tmp * 4)] = h[hoffset_tmp] - (rtDW.sum1 * rtDW.tst);
            }
            ...
            for (j = 0; j < 4; j++) {
              ...
              z[j + ((s_tmp - 1) * 4)] = z[nr] - (rtDW.sum1 * rtDW.s);
              z[j + (s_tmp * 4)] = z[hoffset_tmp] - (rtDW.sum1 * rtDW.tst);
            }
            break;
    ...
    if (!goto150) {
      ...
      if (((i + 1) != L) && (L == i)) {
        ...
        rtDW.tst = h[((i - 1) * 4) + i];
        rtDW.bb = h[(i * 4) + i];
        xdlanv2_FIBA3SmX_o(&rtDW.s, &rtDW.ba, &rtDW.tst, &rtDW.bb, &rtDW.htmp2,
                           &rtDW.aa, &rtDW.sum1, &rtDW.h21s, &rtDW.cs, &rtDW.sn);
        j = i + ((i - 1) * 4);
        h[j - 1] = rtDW.s;
        its = i + (i * 4);
        h[its - 1] = rtDW.ba;
        ...
        h[its] = rtDW.bb;
        if (4 > (i + 1)) {
          xrot_JzPltzlP_i(3 - i, h, i + ((i + 1) * 4), (i + ((i + 1) * 4)) + 1,
                          rtDW.cs, rtDW.sn);
        }

        xrot_DROkKeLU_e(i - 1, h, 1 + ((i - 1) * 4), 1 + (i * 4), rtDW.cs,
                        rtDW.sn);
        xrot_6iHri7if_j(z, 1 + ((i - 1) * 4), 1 + (i * 4), rtDW.cs, rtDW.sn);
      }
...
static void schur_hD1lAh31_b(const real_T A[16], real_T V[16], real_T T[16])
{
  ...
  if (!p) {
    ...
    V[10] = 1.0;
    xzlarf_tQsI3TnT_o(2, 1, 11, rtDW.tau[1], V, 15, rtDW.work);
    rtDW.k_g = 11;
    while ((rtDW.k_g + 1) <= 12) {
    ...
    V[9] = 0.0;
    V[5] = 1.0;
    xzlarf_tQsI3TnT_o(3, 2, 6, rtDW.tau[0], V, 10, rtDW.work);
    rtDW.k_g = 6;
    while ((rtDW.k_g + 1) <= 8) {
...
void motoraiHIL_step(void)
{
   ...
   *  MATLABSystem: '<S9>/Digital Read'
   */
  if (((uint32_T)rtDW.bitsForTID0.is_active_c1_motoraiHIL) == 0U) {
  ...
  if (rtDW.RateTransition8 != 0.0) {
    if (((int32_T)rtDW.Counter1_Count) < 10000) {
      rtDW.Counter1_Count = (uint16_T)(((uint32_T)rtDW.Counter1_Count) + 1U);
    } else {
      rtDW.Counter1_Count = 0U;
    }
  }
  ...
  if (rtM->Timing.TaskCounters.TID[1] == 0) {
     ...
     *  MATLABSystem: '<S8>/ENC_A'
     */
    rtDW.DataTypeConversion = rtb_ENC_A_0 ? 1.0 : 0.0;
     ...
     *  MATLABSystem: '<S8>/ENC_B'
     */
    rtDW.DataTypeConversion1 = rtb_ENC_A_0 ? 1.0 : 0.0;
    ...
    if (MWDSP_EPH_R_B(((rtDW.SFunction[1] != 0.0) != (rtDW.SFunction[0] != 0.0))
                      != ((rtDW.SFunction_j[0] != 0.0) != (rtDW.SFunction_j[1]
   ...
   *  Logic: '<S2>/NOT'
   */
  MW_digitalIO_write(rtDW.obj_bu.MW_DIGITALIO_HANDLE, (!(rtDW.n_stop_motor !=
    0.0)) ? 1 : 0);
   ...
   */
  /* Delay: '<Root>/Delay4' */
  if ((rtDW.Delay4_DSTATE[0U]) && (((uint32_T)
    ...
    rtDW.R = inv_t6RrLIHb(100.0);
    rtDW.dv3[0] = 400.0;
    rtDW.dv3[2] = 0.0;
    rtDW.dv3[1] = 0.0;
    rtDW.dv3[3] = 1.0;
    inv_6TJweJmr(rtDW.dv3, rtDW.U_m);
    ...
    schur_hD1lAh31_b(rtDW.A, rtDW.U, rtDW.unusedU0);
    rtDW.U_m[0] = rtDW.U[0];
    rtDW.U_m[1] = rtDW.U[1];
    rtDW.U_m[2] = rtDW.U[4];
    rtDW.U_m[3] = rtDW.U[5];
    inv_6TJweJmr(rtDW.U_m, rtDW.dv3);
    rtDW.denAccum = -(1.0 / rtDW.R);
    ...
    inv_6TJweJmr(rtDW.U_m, rtDW.dv3);
    rtDW.Kref = -inv_t6RrLIHb((((0.0 * rtDW.dv3[1]) + rtDW.dv3[0]) * 0.0) +
      (((0.0 * rtDW.dv3[3]) + rtDW.dv3[2]) * rtDW.B_idx_1));

    /* End of MATLAB Function: '<S7>/MATLAB Function' */
  }

  rtPrevZCX.ParameterEstimationLQR1_Trig_ZC = rtDW.Delay4_DSTATE[0] ? 1U : 0U;
  ...
  if (rtM->Timing.TaskCounters.TID[1] == 0) {
    ...
    rtDW.Gain1[1] = 0.083333333333333329 * rtDW.A_idx_0;
  }
   ...
   *  Sum: '<S5>/Add'
   */
  rtDW.Delay5_DSTATE = ((((0.0008056640625 * rtDW.A_idx_2) * 0.5) + 1.0) *
                        rtDW.Kref) + ((rtDW.K[0] * rtDW.A_idx_0) + (rtDW.K[1] *
    rtDW.RateTransition1_n));
