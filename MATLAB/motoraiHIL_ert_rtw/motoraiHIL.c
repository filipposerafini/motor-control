  ...
  if (n >= 1) {
    if (n == 1) {
      ...
      for (k = 2; k <= 1 + n; k++) {
        ...
        if (rtDW.absxk > rtDW.scale_c) {
          rtDW.t = rtDW.scale_c / rtDW.absxk;
          y = y * rtDW.t * rtDW.t + 1.0;
          rtDW.scale_c = rtDW.absxk;
        } else {
          rtDW.t = rtDW.absxk / rtDW.scale_c;
          y += rtDW.t * rtDW.t;
        }
      }
...
static real_T xzlarfg(int32_T n, real_T *alpha1, real_T x[3])
{
  ...
  tau = 0.0;
  if (n > 0) {
    rtDW.xnorm_p = xnrm2_g(n - 1, x);
    if (rtDW.xnorm_p != 0.0) {
      rtDW.xnorm_p = rt_hypotd_snf_a(*alpha1, rtDW.xnorm_p);
      if (*alpha1 >= 0.0) {
        rtDW.xnorm_p = -rtDW.xnorm_p;
      }

      if (fabs(rtDW.xnorm_p) < 1.0020841800044864E-292) {
        knt = -1;
        do {
          knt++;
          for (c_k = 1; c_k < n; c_k++) {
          ...
          rtDW.xnorm_p *= 9.9792015476736E+291;
          *alpha1 *= 9.9792015476736E+291;
        } while (!(fabs(rtDW.xnorm_p) >= 1.0020841800044864E-292));

        rtDW.xnorm_p = rt_hypotd_snf_a(*alpha1, xnrm2_g(n - 1, x));
        if (*alpha1 >= 0.0) {
          rtDW.xnorm_p = -rtDW.xnorm_p;
        }

        tau = (rtDW.xnorm_p - *alpha1) / rtDW.xnorm_p;
        *alpha1 = 1.0 / (*alpha1 - rtDW.xnorm_p);
        for (c_k = 1; c_k < n; c_k++) {
          x[c_k] *= *alpha1;
        }

        for (c_k = 0; c_k <= knt; c_k++) {
          rtDW.xnorm_p *= 1.0020841800044864E-292;
        }
                    ...
                    *sn)
{
  ...
  if (*c == 0.0) {
    ...
    *c = 0.0;
    ...
    rtDW.tau_b = *a - *d;
    if ((rtDW.tau_b == 0.0) && ((*b < 0.0) != (*c < 0.0))) {
      *cs = 1.0;
      *sn = 0.0;
    } else {
      rtDW.p = 0.5 * rtDW.tau_b;
      rtDW.bcmis = fabs(*b);
      rtDW.z = fabs(*c);
      ...
      if (rtDW.z >= 8.8817841970012523E-16) {
        if (!(rtDW.p < 0.0)) {
          rtDW.tau_b = sqrt(rtDW.scale) * sqrt(rtDW.z);
        } else {
          rtDW.tau_b = -(sqrt(rtDW.scale) * sqrt(rtDW.z));
        }

        rtDW.z = rtDW.p + rtDW.tau_b;
        *a = *d + rtDW.z;
        *d -= rtDW.bcmax / rtDW.z * rtDW.bcmis;
        rtDW.tau_b = rt_hypotd_snf_a(*c, rtDW.z);
        *cs = rtDW.z / rtDW.tau_b;
        *sn = *c / rtDW.tau_b;
        *b -= *c;
        *c = 0.0;
      } else {
        rtDW.bcmax = *b + *c;
        rtDW.tau_b = rt_hypotd_snf_a(rtDW.bcmax, rtDW.tau_b);
        *cs = sqrt((fabs(rtDW.bcmax) / rtDW.tau_b + 1.0) * 0.5);
        if (!(rtDW.bcmax < 0.0)) {
          b_0 = 1;
        } else {
          b_0 = -1;
        ...
        *sn = -(rtDW.p / (rtDW.tau_b * *cs)) * (real_T)b_0;
        rtDW.p = *a * *cs + *b * *sn;
        rtDW.tau_b = -*a * *sn + *b * *cs;
        rtDW.bcmax = *c * *cs + *d * *sn;
        rtDW.bcmis = -*c * *sn + *d * *cs;
        *b = rtDW.tau_b * *cs + rtDW.bcmis * *sn;
        *c = -rtDW.p * *sn + rtDW.bcmax * *cs;
        rtDW.bcmax = ((rtDW.p * *cs + rtDW.bcmax * *sn) + (-rtDW.tau_b * *sn +
          rtDW.bcmis * *cs)) * 0.5;
        *a = rtDW.bcmax;
        *d = rtDW.bcmax;
        if (*c != 0.0) {
          if (*b != 0.0) {
            if ((*b < 0.0) == (*c < 0.0)) {
              ...
              rtDW.tau_b = 1.0 / sqrt(fabs(*b + *c));
              *a = rtDW.bcmax + rtDW.p;
              *d = rtDW.bcmax - rtDW.p;
              *b -= *c;
              *c = 0.0;
              rtDW.p = rtDW.z * rtDW.tau_b;
              rtDW.tau_b *= rtDW.bcmis;
              rtDW.bcmax = *cs * rtDW.p - *sn * rtDW.tau_b;
              *sn = *cs * rtDW.tau_b + *sn * rtDW.p;
              *cs = rtDW.bcmax;
            }
          } else {
            *b = -*c;
...
void motoraiHIL_step(void)
{
   ...
   *  Product: '<S6>/Divide1'
   */
  MW_PWM_SetDutyCycle(rtDW.obj_ko.MW_PWM_HANDLE, rtDW.Delay5_DSTATE / 12.0 *
                      100.0);
  ...
  if (rtDW.Delay4_DSTATE[0U] && (rtPrevZCX.ParameterEstimationLQR1_Trig_ZC !=
     ...
     *  DotProduct: '<S99>/Dot Product'
     */
    rtDW.dv0[0] = rtDW.A_idx_0;
    rtDW.dv0[1] = rtDW.A_idx_2;
    rtDW.dv0[2] = rtDW.A_idx_1;
    rtDW.dv0[3] = rtDW.A_idx_3;
    rtDW.dv0[4] = rtDW.B_idx_1;
    rtDW.dv0[5] = rtDW.U_tmp;
    rtDW.dv0[6] = rtDW.U_tmp_c;
    rtDW.dv0[7] = rtDW.d0;
    rtDW.dv0[8] = rtDW.d1;
    rtDW.dv0[9] = rtDW.d2;
    rtDW.dv0[10] = rtDW.d3;
    ...
    rtDW.dv0[15] = rtDW.d8;
    rtDW.dv0[16] = rtDW.d9;
    rtDW.dv0[17] = rtDW.d10;
    rtDW.dv0[18] = rtDW.d11;
    rtDW.dv0[19] = rtDW.d12;
    rtDW.dv0[20] = rtDW.d13;
    rtDW.dv0[21] = rtDW.d14;
    rtDW.dv0[22] = rtDW.d15;
    rtDW.dv0[23] = rtDW.d16;
    rtDW.dv0[24] = rtDW.d17;
    rtDW.dv0[25] = rtDW.d18;
    rtDW.dv0[26] = rtDW.d19;
    rtDW.dv0[27] = rtDW.d20;
    rtDW.dv0[28] = rtDW.d21;
    rtDW.dv0[29] = rtDW.d22;
    rtDW.dv0[30] = rtDW.d23;
    rtDW.dv0[31] = rtDW.d24;
    rtDW.dv0[32] = rtDW.d25;
    rtDW.dv0[33] = rtDW.d26;
    rtDW.dv0[34] = rtDW.d27;
    rtDW.dv0[35] = rtDW.d28;
    rtDW.dv0[36] = rtDW.d29;
    rtDW.dv0[37] = rtDW.d30;
    rtDW.dv0[38] = rtDW.d31;
    rtDW.dv0[39] = rtDW.d32;
    rtDW.dv0[40] = rtDW.d33;
    rtDW.dv0[41] = rtDW.d34;
    rtDW.dv0[42] = rtDW.d35;
    rtDW.dv0[43] = rtDW.d36;
    rtDW.dv0[44] = rtDW.d37;
    rtDW.dv0[45] = rtDW.d38;
    rtDW.dv0[46] = rtDW.d39;
    rtDW.dv0[47] = rtDW.d40;
    rtDW.dv0[48] = rtDW.d41;
    rtDW.dv0[49] = rtDW.d42;
    rtDW.dv0[50] = rtDW.d43;
    rtDW.dv0[51] = rtDW.d44;
    rtDW.dv0[52] = rtDW.d45;
    rtDW.dv0[53] = rtDW.d46;
    rtDW.dv0[54] = rtDW.rtb_netsum_k;
    rtDW.dv0[55] = rtDW.d47;
    rtDW.dv0[56] = rtDW.d48;
    rtDW.dv0[57] = rtDW.d49;
    rtDW.dv0[58] = rtDW.d50;
    rtDW.dv0[59] = rtDW.d51;
    rtDW.dv0[60] = rtDW.d52;
    rtDW.dv0[61] = rtDW.d53;
    rtDW.dv0[62] = rtDW.d54;
    rtDW.dv0[63] = rtDW.d55;
    rtDW.dv0[64] = rtDW.d56;
    rtDW.dv0[65] = rtDW.d57;
    rtDW.dv0[66] = rtDW.d58;
    rtDW.dv0[67] = rtDW.d59;
    rtDW.dv0[68] = rtDW.d60;
    rtDW.dv0[69] = rtDW.d61;
    rtDW.dv0[70] = rtDW.d62;
    rtDW.dv0[71] = rtDW.d63;
    rtDW.dv0[72] = rtDW.d64;
    rtDW.dv0[73] = rtDW.d65;
    rtDW.dv0[74] = rtDW.d66;
    rtDW.dv0[75] = rtDW.d67;
    rtDW.dv0[76] = rtDW.d68;
    rtDW.dv0[77] = rtDW.d69;
    rtDW.dv0[78] = rtDW.d70;
    rtDW.dv0[79] = rtDW.d71;
    rtDW.dv0[80] = rtDW.d72;
    rtDW.dv0[81] = rtDW.d73;
    rtDW.dv0[82] = rtDW.d74;
    rtDW.dv0[83] = rtDW.d75;
    rtDW.dv0[84] = rtDW.d76;
    rtDW.dv0[85] = rtDW.d77;
    rtDW.dv0[86] = rtDW.d78;
    rtDW.dv0[87] = rtDW.d79;
    rtDW.dv0[88] = rtDW.d80;
    rtDW.dv0[89] = rtDW.d81;
    rtDW.dv0[90] = rtDW.d82;
    rtDW.dv0[91] = rtDW.d83;
    rtDW.dv0[92] = rtDW.d84;
    rtDW.dv0[93] = rtDW.d85;
    rtDW.dv0[94] = rtDW.d86;
    rtDW.dv0[95] = rtDW.d87;
    rtDW.dv0[96] = rtDW.d88;
    rtDW.dv0[97] = rtDW.d89;
    rtDW.dv0[98] = rtDW.d90;
    rtDW.dv0[99] = rtDW.d91;
    rtDW.dv0[100] = rtDW.d92;
    rtDW.dv0[101] = rtDW.d93;
    rtDW.dv0[102] = rtDW.d94;
    rtDW.dv0[103] = rtDW.d95;
    rtDW.dv0[104] = rtDW.d96;
    rtDW.dv0[105] = rtDW.d97;
    rtDW.dv0[106] = rtDW.d98;
    rtDW.dv0[107] = rtDW.d99;
    rtDW.dv0[108] = rtDW.d100;
    rtDW.dv0[109] = rtDW.d101;
    rtDW.dv0[110] = rtDW.d102;
    rtDW.dv0[111] = rtDW.d103;
    rtDW.dv0[112] = rtDW.d104;
    rtDW.dv0[113] = rtDW.d105;
    rtDW.dv0[114] = rtDW.d106;
    rtDW.dv0[115] = rtDW.d107;
    rtDW.dv0[116] = rtDW.d108;
    rtDW.dv0[117] = rtDW.d109;
    rtDW.dv0[118] = rtDW.d110;
    rtDW.dv0[119] = rtDW.d111;
    rtDW.dv0[120] = rtDW.d112;
    rtDW.dv0[121] = rtDW.d113;
    rtDW.dv0[122] = rtDW.d114;
    rtDW.dv0[123] = rtDW.d115;
    rtDW.dv0[124] = rtDW.d116;
    rtDW.dv0[125] = rtDW.d117;
    rtDW.dv0[126] = rtDW.d118;
    rtDW.dv0[127] = rtDW.d119;
    rtDW.dv0[128] = rtDW.d120;
    rtDW.dv0[129] = rtDW.d121;
    rtDW.dv0[130] = rtDW.d122;
    rtDW.dv0[131] = rtDW.d123;
    rtDW.dv0[132] = rtDW.d124;
    rtDW.dv0[133] = rtDW.d125;
    rtDW.dv0[134] = rtDW.d126;
    rtDW.dv0[135] = rtDW.d127;
    rtDW.dv0[136] = rtDW.d128;
    rtDW.dv0[137] = rtDW.d129;
    rtDW.dv0[138] = rtDW.d130;
    rtDW.dv0[139] = rtDW.d131;
    rtDW.dv0[140] = rtDW.d132;
    rtDW.dv0[141] = rtDW.d133;
    rtDW.dv0[142] = rtDW.d134;
    rtDW.dv0[143] = rtDW.d135;
    rtDW.dv0[144] = rtDW.d136;
    rtDW.dv0[145] = rtDW.d137;
    rtDW.dv0[146] = rtDW.d138;
    rtDW.dv0[147] = rtDW.d139;
    rtDW.dv0[148] = rtDW.d140;
    rtDW.dv0[149] = rtDW.d141;
    rtDW.dv0[150] = rtDW.d142;
    rtDW.dv0[151] = rtDW.d143;
    rtDW.dv0[152] = rtDW.d144;
    rtDW.dv0[153] = rtDW.d145;
    rtDW.dv0[154] = rtDW.d146;
    rtDW.dv0[155] = rtDW.d147;
    rtDW.dv0[156] = rtDW.d148;
    rtDW.dv0[157] = rtDW.d149;
    rtDW.dv0[158] = rtDW.d150;
    rtDW.dv0[159] = rtDW.d151;
    rtDW.dv0[160] = rtDW.d152;
    rtDW.dv0[161] = rtDW.d153;
    rtDW.dv0[162] = rtDW.d154;
    rtDW.dv0[163] = rtDW.d155;
    rtDW.dv0[164] = rtDW.d156;
    rtDW.dv0[165] = rtDW.d157;
     ...
     *  DotProduct: '<S243>/Dot Product'
     */
    rtDW.dv1[0] = rtDW.A_idx_0;
    rtDW.dv1[1] = rtDW.A_idx_2;
    rtDW.dv1[2] = rtDW.A_idx_1;
    rtDW.dv1[3] = rtDW.A_idx_3;
    rtDW.dv1[4] = rtDW.B_idx_1;
    rtDW.dv1[5] = rtDW.U_tmp;
    rtDW.dv1[6] = rtDW.U_tmp_c;
    rtDW.dv1[7] = rtDW.d0;
    rtDW.dv1[8] = rtDW.d1;
    rtDW.dv1[9] = rtDW.d2;
    rtDW.dv1[10] = rtDW.d3;
    ...
    rtDW.dv1[15] = rtDW.d8;
    rtDW.dv1[16] = rtDW.d9;
    rtDW.dv1[17] = rtDW.d10;
    rtDW.dv1[18] = rtDW.d11;
    rtDW.dv1[19] = rtDW.d12;
    rtDW.dv1[20] = rtDW.d13;
    rtDW.dv1[21] = rtDW.d14;
    rtDW.dv1[22] = rtDW.d15;
    rtDW.dv1[23] = rtDW.d16;
    rtDW.dv1[24] = rtDW.d17;
    rtDW.dv1[25] = rtDW.d18;
    rtDW.dv1[26] = rtDW.d19;
    rtDW.dv1[27] = rtDW.d20;
    rtDW.dv1[28] = rtDW.d21;
    rtDW.dv1[29] = rtDW.d22;
    rtDW.dv1[30] = rtDW.d23;
    rtDW.dv1[31] = rtDW.d24;
    rtDW.dv1[32] = rtDW.d25;
    rtDW.dv1[33] = rtDW.d26;
    rtDW.dv1[34] = rtDW.d27;
    rtDW.dv1[35] = rtDW.d28;
    rtDW.dv1[36] = rtDW.d29;
    rtDW.dv1[37] = rtDW.d30;
    rtDW.dv1[38] = rtDW.d31;
    rtDW.dv1[39] = rtDW.d32;
    rtDW.dv1[40] = rtDW.d33;
    rtDW.dv1[41] = rtDW.d34;
    rtDW.dv1[42] = rtDW.d35;
    rtDW.dv1[43] = rtDW.d36;
    rtDW.dv1[44] = rtDW.d37;
    rtDW.dv1[45] = rtDW.d38;
    rtDW.dv1[46] = rtDW.d39;
    rtDW.dv1[47] = rtDW.d40;
    rtDW.dv1[48] = rtDW.d41;
    rtDW.dv1[49] = rtDW.d42;
    rtDW.dv1[50] = rtDW.d43;
    rtDW.dv1[51] = rtDW.d44;
    rtDW.dv1[52] = rtDW.d45;
    rtDW.dv1[53] = rtDW.d46;
    ...
    for (rtDW.k = 0; rtDW.k < 54; rtDW.k++) {
       ...
       */
      rtDW.A_idx_0 += rtConstP.IW321_Value[rtDW.k] * rtDW.rtb_netsum_k;

      /* DotProduct: '<S248>/Dot Product' incorporates:
       *  Constant: '<S245>/IW{3,2}(2,:)''
       */
      rtDW.A_idx_2 += rtConstP.IW322_Value[rtDW.k] * rtDW.rtb_netsum_k;

      /* DotProduct: '<S249>/Dot Product' incorporates:
       *  Constant: '<S245>/IW{3,2}(3,:)''
       */
      rtDW.A_idx_1 += rtConstP.IW323_Value[rtDW.k] * rtDW.rtb_netsum_k;

      /* DotProduct: '<S250>/Dot Product' incorporates:
       *  Constant: '<S245>/IW{3,2}(4,:)''
       */
      rtDW.A_idx_3 += rtConstP.IW324_Value[rtDW.k] * rtDW.rtb_netsum_k;

      /* DotProduct: '<S251>/Dot Product' incorporates:
       *  Constant: '<S245>/IW{3,2}(5,:)''
       */
      rtDW.B_idx_1 += rtConstP.IW325_Value[rtDW.k] * rtDW.rtb_netsum_k;
    }
     ...
     *  DotProduct: '<S251>/Dot Product'
     */
    rtDW.dv2[0] = rtDW.A_idx_0;
    rtDW.dv2[1] = rtDW.A_idx_2;
    rtDW.dv2[2] = rtDW.A_idx_1;
    rtDW.dv2[3] = rtDW.A_idx_3;
    rtDW.dv2[4] = rtDW.B_idx_1;
    for (rtDW.k = 0; rtDW.k < 5; rtDW.k++) {
       ...
       */
      rtDW.A_idx_2 = log10(rtConstP.Constant_Value[rtDW.k]);
      rtDW.decoded[rtDW.k] = rt_powd_snf(10.0, (((rtDW.dv2[rtDW.k] +
        ...
        rtDW.k]) - rtDW.A_idx_2) + rtDW.A_idx_2);
    }
    ...
    if (rtb_ENC_A_0) {
      for (rtDW.k = 0; rtDW.k < 5; rtDW.k++) {
        rtDW.A_idx_2 = rtDW.decoded[rtDW.k];
        rtDW.A_idx_0 = rtConstP.Constant_Value[5 + rtDW.k];
        if (rtDW.decoded[rtDW.k] > rtDW.A_idx_0) {
          rtDW.A_idx_2 = rtDW.A_idx_0;
        }

        rtDW.decoded[rtDW.k] = rtDW.A_idx_2;
      }
    } else {
      rtb_ENC_A_0 = false;
      rtDW.k = 0;
      ...
      if (rtb_ENC_A_0) {
        for (rtDW.k = 0; rtDW.k < 5; rtDW.k++) {
          rtDW.A_idx_2 = rtDW.decoded[rtDW.k];
          if (rtDW.decoded[rtDW.k] < rtConstP.Constant_Value[rtDW.k]) {
            rtDW.A_idx_2 = rtConstP.Constant_Value[rtDW.k];
          }
    ...
    rtDW.A[9] = -(100.0 * rtDW.B_idx_1 * 0.0);
    rtDW.A[3] = -(0.5 * rtDW.U_m[1]);
    rtDW.A[11] = -rtDW.A_idx_2;
    rtDW.A[12] = -(0.0 * rtDW.B_idx_1);
    rtDW.A[6] = -(0.5 * rtDW.U_m[2]);
    rtDW.A[14] = -rtDW.A_idx_1;
    rtDW.A[13] = -(100.0 * rtDW.B_idx_1 * rtDW.B_idx_1);
    ...
    for (rtDW.k = 0; rtDW.k < 2; rtDW.k++) {
      rtDW.U_m[rtDW.k] = 0.0;
      rtDW.U_tmp = rtDW.U[2 + rtDW.k];
      rtDW.U_m[rtDW.k] += rtDW.U_tmp * rtDW.dv3[0];
      rtDW.U_tmp_c = rtDW.U[rtDW.k + 6];
      rtDW.U_m[rtDW.k] += rtDW.U_tmp_c * rtDW.dv3[1];
      rtDW.U_m[rtDW.k + 2] = 0.0;
      rtDW.U_m[rtDW.k + 2] += rtDW.U_tmp * rtDW.dv3[2];
      rtDW.U_m[rtDW.k + 2] += rtDW.U_tmp_c * rtDW.dv3[3];
    }

    rtDW.K[0] = 0.0;
    rtDW.K[0] += -0.0 * rtDW.U_m[0];
    rtDW.K[0] += -100.0 * rtDW.B_idx_1 * rtDW.U_m[1];
    rtDW.K[1] = 0.0;
    rtDW.K[1] += -0.0 * rtDW.U_m[2];
    rtDW.K[1] += -100.0 * rtDW.B_idx_1 * rtDW.U_m[3];
    ...
    inv(rtDW.U_m, rtDW.dv3);
    rtDW.Kref = -(1.0 / ((0.0 * rtDW.dv3[1] + rtDW.dv3[0]) * 0.0 + (0.0 *
  ...
  rtDW.A_idx_0 = rtDW.RateTransition6 - rtDW.DiscreteTransferFcn_states;
  rtDW.A_idx_2 = 199999.99999999997 * rtDW.A_idx_0 + -199999.99999999997 *
    rtDW.DiscreteTransferFcn_states;

  /* RateTransition: '<Root>/Rate Transition5' */
  if (rtM->Timing.TaskCounters.TID[1] == 0) {
    /* Gain: '<Root>/Gain1' */
    rtDW.Gain1[0] = 0.083333333333333329 * rtDW.RateTransition4;
    rtDW.Gain1[1] = 0.083333333333333329 * rtDW.A_idx_2;
  }
  ...
  MW_AnalogInSingle_ReadResult(rtDW.obj.MW_ANALOGIN_HANDLE, &rtDW.A_idx_1, 7);
   ...
   *  Sum: '<S5>/Add'
   */
  rtDW.Delay5_DSTATE = (0.0008056640625 * rtDW.A_idx_1 * 0.5 + 1.0) * rtDW.Kref
    + (rtDW.K[0] * rtDW.A_idx_2 + rtDW.K[1] * rtDW.RateTransition1_n);
  ...
  rtDW.DiscreteTransferFcn_states = rtDW.A_idx_0;
  rate_scheduler();
}
